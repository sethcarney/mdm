...
Prefer a UI? The [**mdm**](https://marketplace.visualstudio.com/items?itemName=SethsSoftware.mdm-sidebar) VS Code extension visualizes your installed skills and agent rules alongside the CLI. [Source](https://github.com/sethcarney/mdm-vscode).
