...
| `--install`, `-i` | Also install the forks into your harnesses' skills directories |
| `--harness` | Harnesses to install the forks to (repeatable; implies `--install`) |
...
- `mdm skills remove` uninstalls the skill from your harnesses and leaves the fork
  in `./skills` alone.
